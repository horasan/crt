...
public class SwaggerConfiguration {
	...
	public static final Contact API_INFO_CONTACT = new Contact(
			"Riza Horasan",
			"",
			"rizahorasan@gmail.com");
	  public static final ApiInfo API_INFO = new ApiInfo(
			  "Competitor Ranking APIs",
			  "Competitor Ranking APIs provides features for Competitor Ranking Tool.", "1.0", "urn:tos",
			  API_INFO_CONTACT, "Apache 2.0", "http://www.apache.org/licenses/LICENSE-2.0", new ArrayList<VendorExtension>());
