...
public class CompetitionResultBM implements Comparable<CompetitionResultBM> {
	...
	/**
	 * Compares given CompetitionResultBM to itself.
	 * Returns -1: If rank of against is bigger
	 * 			1: If rank of against is smaller
	 * 			0: If rank of against is the same
	 */
	@Override
	...
	public String toString() {
		return String.format("%s %s %s %s", competitorBM.getCompetitorId(), competitorBM.getName(), accumulatedPoints.toString(), ranking.toString());   
	}
